      ...
      >
        <View style={styles.subsection}>
          ...
          <Text style={styles.marginTopText}>
            ...
            surgery, but he is procrastinating because he doesn't feel like
            doing it! It's pretty hard to imagine, isn't it! Similarly, you have
            things to do, so no matter how you feel, get them done!
          </Text>
          ...
          <Text style={styles.marginTopText}>
            Fail better! "Don't associate failure with inadequacy. Embrace
            failure as a testament to your commitment. When your best effort
            paves the way, a sense of fulfillment follows even in failure.
            However, failing due to withheld potential lingers as regret, a
            reminder that you possessed the capacity to excel but chose
            otherwise."
          </Text>
          <Text style={styles.text}>
            PROCESS ISSUES - if there's one thing I want you to get from all
            this is “learn how to process issues”
          </Text>
          <Text style={styles.text}>
            Last but not least: Workout everyday, you need to lose sweat, to
            flush all the junk in your body! Don't be a perfectionist! Have a
            growth mindset! Organize your workplace! Set deadlines (Parkinson's
            Law)! Have a To-do list, practice gratitude, and an end of the day
        ...
        <Text style={styles.checkboxLabel}>
          Save your Personal Quotes Below!
        </Text>
        <QuoteDisplay />
        <View style={{ flexDirection: "row", justifyContent: "space-evenly" }}>
          <TouchableOpacity
            onPress={() =>
              handleLinkPress("https://github.com/ABHIGYAN-MOHANTA")
            }
          >
          ...
          <TouchableOpacity
            onPress={() =>
              handleLinkPress("https://twitter.com/MohantaAbhigyan")
            }
          >
